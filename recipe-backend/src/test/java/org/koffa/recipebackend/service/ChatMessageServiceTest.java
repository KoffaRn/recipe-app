...
class ChatMessageServiceTest {
    ...
    /**
     * Method under test: {@link ChatMessageService#deleteByRecipeId(long)}
     */
    @Test
    void testDeleteByRecipeId() {
        doNothing().when(chatMessageRepository).deleteByRecipeId(anyLong());
        chatMessageService.deleteByRecipeId(1L);
        verify(chatMessageRepository).deleteByRecipeId(anyLong());
    }
}
